    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 border-b border-gray-200 sm:px-6">
            ...
            <p class="mt-1 max-w-2xl text-sm text-gray-500">
                {{ __('messages.add_new_service_desc') }}
            </p>
        </div>
            ...
            <form action="{{ route('admin.services.store') }}" method="POST" id="serviceForm">
                ...
                <div class="space-y-6">
                        ...
                        <div class="mt-1">
                            <select id="service_group_id" name="service_group_id" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                ...
                                @foreach($serviceGroups as $id => $name)
                                    <option value="{{ $id }}" {{ old('service_group_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="name" id="name" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="{{ __('messages.service_name') }}" value="{{ old('name') }}" required>
                        </div>
                        @error('name')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea name="description" id="description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="{{ __('messages.description') }}">{{ old('description') }}</textarea>
                        </div>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="url" name="url" id="url" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="https://api.example.com/status" value="{{ old('url') }}" required>
                        </div>
                        @error('url')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="number" name="expected_status_code" id="expected_status_code" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="200" value="{{ old('expected_status_code', 200) }}">
                            </div>
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="number" name="timeout" id="timeout" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="5" value="{{ old('timeout', 5) }}" min="1" max="60">
                            </div>
                            @error('timeout')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="number" name="display_order" id="display_order" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="0" value="{{ old('display_order', 0) }}" min="0">
                            </div>
                            @error('display_order')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea name="headers" id="headers" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md font-mono" placeholder='{"Authorization": "Bearer token", "Content-Type": "application/json"}'>{{ old('headers') }}</textarea>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea name="payload" id="payload" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md font-mono" placeholder='{"key": "value"}'>{{ old('payload') }}</textarea>
                        </div>
                        <p class="mt-2 text-xs text-gray-500">
                    ...
                    <div class="relative flex items-start">
                        <div class="flex items-center h-5">
                            <input id="active" name="active" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" {{ old('active', true) ? 'checked' : '' }}>
                        </div>
